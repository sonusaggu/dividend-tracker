...
class EmailRegistrationForm(forms.Form):
    """Step 1 of email-first registration — email address only."""
    ...
    def clean_email(self):
        ...
        if existing:
            ...
            # Inactive account → caller will resend verification
...
class SetPasswordForm(forms.Form):
    """Step 3 of email-first registration — choose a password."""
