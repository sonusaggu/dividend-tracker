...
urlpatterns = [
    ...
    path('earnings-calendar/', views.earnings_calendar, name='earnings_calendar'),
    path('stocks/<str:symbol>/earnings/', views.stock_earnings, name='stock_earnings'),
    path('stocks/<str:symbol>/news/', views.stock_news, name='stock_news'),
    path('stocks/<str:symbol>/<str:slug>/', views.stock_detail, name='stock_detail'),
    ...
    # Insider Trades API
    path('api/insider-trades/fetch/', views.trigger_insider_trades, name='trigger_insider_trades'),
    path('api/insider-trades/<str:symbol>/', views.insider_trades_list, name='insider_trades_list'),
